...
<div class="wxapi_container">
    <div class="wxapi_index_container">
        <ul class="label_box lbox_close wxapi_index_list">
            <li class="label_item wxapi_index_item"><a class="label_inner" href="#menu-basic">接触接口 dddddddddddddddddd</a></li>
...
<script src="${pageContext.request.contextPath}/views/js/zepto.min.js"></script>
<script src="${pageContext.request.contextPath}/views/js/demo.js"> </script>
</html>
